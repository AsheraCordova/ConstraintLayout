...
NSString *ADXMLMotionPaths_TAG = @"MLMotionPaths";
IOSObjectArray *ADXMLMotionPaths_names;

@implementation ADXMLMotionPaths

- (instancetype)initPackagePrivate {
  ADXMLMotionPaths_initPackagePrivate(self);
  return self;
}
...
- (instancetype)initPackagePrivateWithInt:(jint)parentWidth
                     ...
                     withADXMLMotionPaths:(ADXMLMotionPaths *)startTimePoint
                     withADXMLMotionPaths:(ADXMLMotionPaths *)endTimePoint {
  ADXMLMotionPaths_initPackagePrivateWithInt_withInt_withADXKeyPosition_withADXMLMotionPaths_withADXMLMotionPaths_(self, parentWidth, parentHeight, c, startTimePoint, endTimePoint);
  return self;
}
...
- (void)initScreenWithInt:(jint)parentWidth
  ...
  point->width_ = JreFpToInt((startTimePoint->width_ + scaleX * scaleWidth));
  point->height_ = JreFpToInt((startTimePoint->height_ + scaleY * scaleHeight));
  point->mMode_ = ADXMLMotionPaths_SCREEN;
...
- (void)differentWithADXMLMotionPaths:(ADXMLMotionPaths *)points
  ...
  *IOSBooleanArray_GetRef(mask, c++) |= (diffx | diffy | arcMode);
  *IOSBooleanArray_GetRef(mask, c++) |= ADXMLMotionPaths_diffWithFloat_withFloat_(self, width_, points->width_);
...
- (void)getCenterWithDouble:(jdouble)p
  ...
  for (jint i = 0; i < ((IOSIntArray *) nil_chk(toUse))->size_; i++) {
    ...
    switch (IOSIntArray_Get(toUse, i)) {
      ...
      v_x = value;
      break;
      case ADXMLMotionPaths_OFF_Y:
      v_y = value;
      break;
      case ADXMLMotionPaths_OFF_WIDTH:
      v_width = value;
      break;
      case ADXMLMotionPaths_OFF_HEIGHT:
      v_height = value;
      break;
    }
  }
...
- (void)setViewWithFloat:(jfloat)position
  ...
  for (jint i = 0; i < ((IOSDoubleArray *) nil_chk(mTempValue_))->size_; i++) {
    ...
    switch (i) {
      ...
      dv_height = dvalue;
      break;
      case ADXMLMotionPaths_OFF_PATH_ROTATE:
      path_rotate = value;
      break;
    }
  }
...
- (void)applyParametersWithADXConstraintSet_Constraint:(ADXConstraintSet_Constraint *)c {
  ADXMLMotionPaths *point = self;
  JreStrongAssign(&point->mKeyFrameEasing_, ADXEasing_getInterpolatorWithNSString_(((ADXConstraintSet_Motion *) nil_chk(((ADXConstraintSet_Constraint *) nil_chk(c))->motion_))->mTransitionEasing_));
  point->mPathMotionArc_ = c->motion_->mPathMotionArc_;
  ...
  point->mProgress_ = ((ADXConstraintSet_PropertySet *) nil_chk(c->propertySet_))->mProgress_;
  point->mRelativeAngle_ = ((ADXConstraintSet_Layout *) nil_chk(c->layout_))->circleAngle_;
...
- (void)configureRelativeToWithADXMotionController:(ADXMotionController *)toOrbit {
  IOSDoubleArray *p = [((ADXMotionController *) nil_chk(toOrbit)) getPosWithDouble:mProgress_];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(initCartesianWithADXKeyPosition:withADXMLMotionPaths:withADXMLMotionPaths:);
  methods[2].selector = @selector(initPackagePrivateWithInt:withInt:withADXKeyPosition:withADXMLMotionPaths:withADXMLMotionPaths:);
  methods[3].selector = @selector(initPolarWithInt:withInt:withADXKeyPosition:withADXMLMotionPaths:withADXMLMotionPaths:);
  methods[4].selector = @selector(setupRelativeWithADXMotionController:withADXMLMotionPaths:);
  methods[5].selector = @selector(initScreenWithInt:withInt:withADXKeyPosition:withADXMLMotionPaths:withADXMLMotionPaths:);
  methods[6].selector = @selector(initPathWithADXKeyPosition:withADXMLMotionPaths:withADXMLMotionPaths:);
  ...
  methods[10].selector = @selector(differentWithADXMLMotionPaths:withBooleanArray:withNSStringArray:withBoolean:);
  ...
  methods[15].selector = @selector(setViewWithFloat:withADView:withIntArray:withDoubleArray:withDoubleArray:withDoubleArray:);
  ...
  methods[24].selector = @selector(applyParametersWithADXConstraintSet_Constraint:);
  methods[25].selector = @selector(configureRelativeToWithADXMotionController:);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "TAG", "LNSString;", .constantValue.asLong = 0, 0x19, -1, 41, -1, -1 },
    { "DEBUG", "Z", .constantValue.asBOOL = ADXMLMotionPaths_DEBUG, 0x19, -1, -1, -1, -1 },
    { "OLD_WAY", "Z", .constantValue.asBOOL = ADXMLMotionPaths_OLD_WAY, 0x19, -1, -1, -1, -1 },
    { "OFF_POSITION", "I", .constantValue.asInt = ADXMLMotionPaths_OFF_POSITION, 0x18, -1, -1, -1, -1 },
    { "OFF_X", "I", .constantValue.asInt = ADXMLMotionPaths_OFF_X, 0x18, -1, -1, -1, -1 },
    { "OFF_Y", "I", .constantValue.asInt = ADXMLMotionPaths_OFF_Y, 0x18, -1, -1, -1, -1 },
    { "OFF_WIDTH", "I", .constantValue.asInt = ADXMLMotionPaths_OFF_WIDTH, 0x18, -1, -1, -1, -1 },
    { "OFF_HEIGHT", "I", .constantValue.asInt = ADXMLMotionPaths_OFF_HEIGHT, 0x18, -1, -1, -1, -1 },
    { "OFF_PATH_ROTATE", "I", .constantValue.asInt = ADXMLMotionPaths_OFF_PATH_ROTATE, 0x18, -1, -1, -1, -1 },
    { "PERPENDICULAR", "I", .constantValue.asInt = ADXMLMotionPaths_PERPENDICULAR, 0x18, -1, -1, -1, -1 },
    { "CARTESIAN", "I", .constantValue.asInt = ADXMLMotionPaths_CARTESIAN, 0x18, -1, -1, -1, -1 },
    { "SCREEN", "I", .constantValue.asInt = ADXMLMotionPaths_SCREEN, 0x18, -1, -1, -1, -1 },
    ...
    { "mRelativeToController_", "LADXMotionController;", .constantValue.asLong = 0, 0x0, -1, -1, -1, -1 },
    { "attributes_", "LJavaUtilLinkedHashMap;", .constantValue.asLong = 0, 0x0, -1, -1, 43, -1 },
  ...
  static const void *ptrTable[] = { "initCartesian", "LADXKeyPosition;LADXMLMotionPaths;LADXMLMotionPaths;", "IILADXKeyPosition;LADXMLMotionPaths;LADXMLMotionPaths;", "initPolar", "setupRelative", "LADXMotionController;LADXMLMotionPaths;", "initScreen", "initPath", "xRotate", "FFFFFF", "yRotate", "diff", "FF", "different", "LADXMLMotionPaths;[Z[LNSString;Z", "getCenter", "D[I[D[FI", "D[I[D[F[D[F", "getCenterVelocity", "getBounds", "[I[D[FI", "setView", "FLADView;[I[D[D[D", "getRect", "setDpDt", "FF[F[I[D[D", "fillStandard", "[D[I", "hasCustomData", "LNSString;", "getCustomDataCount", "getCustomData", "LNSString;[DI", "setBounds", "FFFF", "compareTo", "LADXMLMotionPaths;", "applyParameters", "LADXConstraintSet_Constraint;", "configureRelativeTo", "LADXMotionController;", &ADXMLMotionPaths_TAG, &ADXMLMotionPaths_names, "Ljava/util/LinkedHashMap<Ljava/lang/String;Landroidx/constraintlayout/widget/ConstraintAttribute;>;", "Ljava/lang/Object;Ljava/lang/Comparable<Landroidx/constraintlayout/motion/widget/MLMotionPaths;>;" };
  static const J2ObjcClassInfo _ADXMLMotionPaths = { "MLMotionPaths", "androidx.constraintlayout.motion.widget", ptrTable, methods, fields, 7, 0x0, 26, 32, -1, -1, -1, 44, -1 };
  return &_ADXMLMotionPaths;
}

+ (void)initialize {
  if (self == [ADXMLMotionPaths class]) {
    JreStrongAssignAndConsume(&ADXMLMotionPaths_names, [IOSObjectArray newArrayWithObjects:(id[]){ @"position", @"x", @"y", @"width", @"height", @"pathRotate" } count:6 type:NSString_class_()]);
    J2OBJC_SET_INITIALIZED(ADXMLMotionPaths)
  }
}

@end

void ADXMLMotionPaths_initPackagePrivate(ADXMLMotionPaths *self) {
  NSObject_init(self);
  self->mDrawPath_ = 0;
  self->mPathRotate_ = JavaLangFloat_NaN;
  self->mProgress_ = JavaLangFloat_NaN;
  self->mPathMotionArc_ = JreLoadStatic(ADXKey, UNSET);
  self->mAnimateRelativeTo_ = JreLoadStatic(ADXKey, UNSET);
...
ADXMLMotionPaths *new_ADXMLMotionPaths_initPackagePrivate() {
  J2OBJC_NEW_IMPL(ADXMLMotionPaths, initPackagePrivate)
}

ADXMLMotionPaths *create_ADXMLMotionPaths_initPackagePrivate() {
...
void ADXMLMotionPaths_initPackagePrivateWithInt_withInt_withADXKeyPosition_withADXMLMotionPaths_withADXMLMotionPaths_(ADXMLMotionPaths *self, jint parentWidth, jint parentHeight, ADXKeyPosition *c, ADXMLMotionPaths *startTimePoint, ADXMLMotionPaths *endTimePoint) {
  ...
  JreStrongAssignAndConsume(&self->mTempValue_, [IOSDoubleArray newArrayWithLength:18]);
  JreStrongAssignAndConsume(&self->mTempDelta_, [IOSDoubleArray newArrayWithLength:18]);
  if (((ADXMLMotionPaths *) nil_chk(startTimePoint))->mAnimateRelativeTo_ != JreLoadStatic(ADXKey, UNSET)) {
    [self initPolarWithInt:parentWidth withInt:parentHeight withADXKeyPosition:c withADXMLMotionPaths:startTimePoint withADXMLMotionPaths:endTimePoint];
    return;
  }
  switch (((ADXKeyPosition *) nil_chk(c))->mPositionType_) {
    case ADXKeyPosition_TYPE_SCREEN:
    [self initScreenWithInt:parentWidth withInt:parentHeight withADXKeyPosition:c withADXMLMotionPaths:startTimePoint withADXMLMotionPaths:endTimePoint];
    return;
    case ADXKeyPosition_TYPE_PATH:
    [self initPathWithADXKeyPosition:c withADXMLMotionPaths:startTimePoint withADXMLMotionPaths:endTimePoint];
    return;
    default:
    case ADXKeyPosition_TYPE_CARTESIAN:
    [self initCartesianWithADXKeyPosition:c withADXMLMotionPaths:startTimePoint withADXMLMotionPaths:endTimePoint];
    return;
  }
}
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ADXMLMotionPaths)
